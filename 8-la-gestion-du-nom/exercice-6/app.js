// Exercice 6 : Création d’une Galerie d’Images
// > À partir d'un tableau d'images, créez une liste d'images sur votre page. Assurez-vous que chaque image ait une taille de 300px par 300px 
// sans être déformée. Utilisez Flexbox pour organiser les images de manière esthétique sur la page.
...
for (const image of images) {
    // Creer un element html(img)
    let nouvelElement = document.createElement('img');
    // Changer la source de l'image
    nouvelElement.src = image
    // changer width et height et cover
    nouvelElement.style.height = '300px'
    nouvelElement.style.width = '300px'
    nouvelElement.style.objectFit = 'cover'
    // Ajouter votre img au DOM
